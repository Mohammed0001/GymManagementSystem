 ...
 * @author hp
 */
public class StrategyPayment extends javax.swing.JFrame {
    ...
    /**
     * Creates new form StrategyPayment
     */
    ...
    private void initComponents() {
        ...
        // Populate combo box with payment methods
        ...
        jButton1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Map the selected payment method to the appropriate strategy
                    switch (paymentMethod) {
                        ...
                        case "Bank Transfer":
                            ...
                            break;
                        default:
                            jTextArea1.setText("Unknown payment method selected.");
                            return;
                    }

                    // Process payment and display the result
                    String result = paymentStrategy.processPayment(amount, "USD");
                    jTextArea1.setText(result);

                } catch (NumberFormatException ex) {
                    // Handle invalid number format
                    jTextArea1.setText("Invalid amount entered. Please enter a numeric value.");
                }
            }
        });
    }
